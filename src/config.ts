...
const { PORT, NODE_ENV, GOOGLE_ID_SECRET, GOOGLE_SECRET_CLIENT_PASSWORD, REDIRECT_URL, TOKEN_AUTHORIZED_SESSION, EMAIL_HOST, EMAIL_PORT, EMAIL_SECURE, EMAIL_USER, EMAIL_PASS } = process.env
